...
<div class="well well-lg">
  <h2 style="color:#B30938;text-align:left;"><b>FACULTY</b></h2>            
  <div class="row">
    <div class="col-md-6">
      <a class="thumbnail">
        <img src="facultyone.jpg" alt="Faculty One" class="img-circle" style="width:200px;height:200px;margin-top:10px;">
        <p style="margin-top:10px;"><b>Faculty One</b><br/> Faculty Information<br/><br/><br/><br/><br/></p>
      </a>
    </div>
    <div class="col-md-6">
      <a class="thumbnail" style="margin-top:10px;">
        <img src="facultytwo.jpg" alt="Faculty Two" class="img-circle" style="width:200px;height:200px;margin-top:10px;">
        <p style="margin-top:10px;"><b>Faculty Two</b><br/> Faculty Information<br/><br/><br/><br/><br/></p>
      </a>
    </div>
  </div>
  <div class="row">
    <div class="col-md-6">
      <a class="thumbnail" style="margin-top:10px;">
        <img src="facultythree.jpg" alt="Faculty Three" class="img-circle" style="width:200px;height:200px;margin-top:10px;">
        <p style="margin-top:10px;"><b>Faculty Three</b><br/> Faculty Information<br/><br/><br/><br/><br/></p>
      </a>
    </div>
    <div class="col-md-6">
      <a class="thumbnail" style="margin-top:10px;">
        <img src="facultyfour.jpg" alt="Faculty Four" class="img-circle" style="width:200px;height:200px;margin-top:10px;">
        <p style="margin-top:10px;"><b>Faculty Four</b><br/> Faculty Information<br/><br/><br/><br/><br/></p>
      </a>
    </div>
  </div>
</div>
