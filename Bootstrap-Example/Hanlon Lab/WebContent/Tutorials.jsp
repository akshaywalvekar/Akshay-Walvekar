...
<div class="well well-lg">
	<h3 style="color:#B30938;">GENERAL OPERATION TUTORIALS</h3>
	 <ul class="list-group">
	  <li class="list-group-item">Tutorial One</li>
	  <li class="list-group-item">Tutorial two</li>
	  <li class="list-group-item">Tutorial three</li>
	</ul>  
	</div>
	<div class="well well-lg">
	<h3 style="color:#B30938;">VIDEO TUTORIALS</h3>
	 <div class="row">
	 	
	 	<div class="col-sm-6">
	 		<h4>[HFSL] Behavior Rule</h4>
	 		<iframe width="540" height="338" src="https://www.youtube.com/embed/RUcyKSSh6vI" frameborder="0" allowfullscreen></iframe>
	 	</div>
	 	<div class="col-sm-6">
	 		<h4>[HFSL] Closing Rules</h4>
	 		<iframe width="540" height="338" src="https://www.youtube.com/embed/eCfHK2ta-J4" frameborder="0" allowfullscreen></iframe>
	 	</div>
	 </div>
	 <div class="row">
	 	<div class="col-sm-6">
	 		<h4>[HFSL] Door Access </h4>
	 		<iframe width="540" height="338" src="https://www.youtube.com/embed/pmtYjCCO40E" frameborder="0" allowfullscreen></iframe>
	 	</div>
	 	<div class="col-sm-6">
	 		<h4>[HFSL] After Hour Access</h4>
	 		<iframe width="540" height="338" src="https://www.youtube.com/embed/XI8c5ZORLDk" frameborder="0" allowfullscreen></iframe>
	 	</div>
	 </div>
	 <div class="row">
	 	<div class="col-sm-3">
	 	...
	 	<div class="col-sm-6">
	 		<h4>[HFSL] No Food in the Lab</h4>
	 		<iframe width="540" height="338" src="https://www.youtube.com/embed/Flr_quryYzI" frameborder="0" allowfullscreen></iframe>
	 	</div>
	 	<div class="col-sm-3">
	 	</div>
	 </div> 
	...
	<div class="well well-lg">
	<h3 style="color:#B30938;">SOFTWARE TUTORIALS</h3>
	 <ul class="list-group">
	  <li class="list-group-item">Tutorial One</li>
	  <li class="list-group-item">Tutorial two</li>
	  <li class="list-group-item">Tutorial three</li>
