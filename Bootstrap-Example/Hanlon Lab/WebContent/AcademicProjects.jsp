...
<div class="container" style="margin-top:25px;color:#B30938;" >
	<div class="well well-lg">
		<h3>ACADEMIC RESEARCH PROJECTS</h3>
 		<div class="list-group">
			  <a href="#" class="list-group-item">ACTUS</a>
			  <a href="#" class="list-group-item">Journal-Ranking</a>
			  <a href="#" class="list-group-item">IDEAS: Economics and Finance Research</a>
			  <a href="#" class="list-group-item">Statistical Learning using Market Microstructure Data</a>
			  <a href="#" class="list-group-item">Interacting Networks and High Frequency Finance</a>
