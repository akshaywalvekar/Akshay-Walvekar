...
<body>
	...
	<div class="container" style="margin-top:0px;">
		<ul class="nav nav-tabs nav-justified" style="background:#ffffff;">
    		...
    		<li class="dropdown">
    			<a class="dropdown-toggle" data-toggle="dropdown" href="#" href="#">Course Syllabus
...
<div class="container" id="aboutyou">
	<div class="well well-lg">
		<h3 style="margin-top:0px;">About the Lab</h3>
		<p>The state-of-the-art Hanlon Financial Systems Lab is the heart of 
		the Financial Systems Center in Stevens. This lab came into being 
		as a result of a generous gift by Stevens Trustee and Alumnus, Sean Hanlon. 
		The Lab will integrate the latest hardware and software technologies, 
		accessing real-time data and historical data, supporting innovative research 
		into the most common and urgent problems in contemporary finance</p>
	</div>
	<div class="container">            
            <div class="row">
                <div class="col-sm-6">
                   <iframe width="540" height="338" src="https://www.youtube.com/embed/CXfinCPyoiE" frameborder="0" allowfullscreen></iframe>
                </div>
                <div class="col-sm-6">
                   <iframe width="530" height="338" src="https://www.youtube.com/embed/19WbHL5f6FI" frameborder="0" allowfullscreen></iframe>
                </div>
             </div> 
 	</div>
...
<br/><b>Phone:</b> (201) 216 - 3527 <b>(Deputy Director)</b> / (201) 216 - 5073 <b>(Research Room)</b>
<br/><b>Email:</b> fscadmin@stevens.edu
<br/><b>Address:</b> Babbio Center, 4th Floor, Stevens Institute of Technology, Castle Point on the Hudson, Hoboken, NJ 07030
</div>
</div>
